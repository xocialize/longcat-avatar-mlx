...
|---|---|---|---|
| **bf16** *(this card)* | separate file | 8-step (after merge) or 50-step (without) | flexibility at +2.5 GB disk + extra load step |
| [bf16-dmd-merged](https://huggingface.co/mlx-community/LongCat-Video-Avatar-1.5-bf16-dmd-merged) | merged into DiT weights | 8-step only | recommended default; smallest disk |
